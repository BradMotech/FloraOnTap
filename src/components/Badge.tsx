...
const Badge: React.FC<BadgeProps> = ({ text, variant = 'success' }) => {
  return (
    ...
    >
     ...
     { variant === 'success' ? <Svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <Path
